...
func DrawFlower(s tcell.Screen, random *rand.Rand, x, y, d, t int) {
	...
	case Flowers["sunflower"]:
		if d <= 1 {
			...
			s.PutStrStyled(x-2, y-2, utils.GenerateRandomString(2), colors.Yellow)
			s.PutStrStyled(x+1, y-2, utils.GenerateRandomString(2), colors.Yellow)
			s.PutStrStyled(x-2, y, utils.GenerateRandomString(2), colors.Yellow)
			s.PutStrStyled(x+1, y, utils.GenerateRandomString(2), colors.Yellow)
			s.PutStrStyled(x-1, y+1, utils.GenerateRandomString(3), colors.Yellow)
			s.PutStrStyled(x-1, y-3, utils.GenerateRandomString(3), colors.Yellow)
			s.PutStrStyled(x-3, y-1, utils.GenerateRandomString(2), colors.Yellow)
			s.PutStrStyled(x+2, y-1, utils.GenerateRandomString(2), colors.Yellow)
		} else {
	...
	case Flowers["lavender"]:
		...
		*/
		s.PutStrStyled(x-1, y-1, utils.GenerateRandomTile("o", "O", "0"), colors.Violet)
		s.PutStrStyled(x+1, y-1, utils.GenerateRandomTile("o", "O", "0"), colors.Violet)
		s.PutStrStyled(x-1, y-2, "o o", colors.Violet)
		s.PutStrStyled(x-1, y-3, "o o", colors.Violet)
		s.PutStrStyled(x-1, y-4, " 0 ", colors.Violet)
	case Flowers["poppy"]:
		s.PutStrStyled(x, y, utils.GenerateRandomTile(), colors.Brown)
		s.PutStrStyled(x-1, y+1, utils.GenerateRandomString(3), colors.Red)
		s.PutStrStyled(x-1, y-1, utils.GenerateRandomString(3), colors.Red)
		s.PutStrStyled(x-2, y, utils.GenerateRandomString(2), colors.Red)
		s.PutStrStyled(x+1, y, utils.GenerateRandomString(2), colors.Red)
